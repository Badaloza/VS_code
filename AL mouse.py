...
while True:
    ...
    if len(lmList) != 0:
        ...
        # both index and middle finger up: clicking mode
        ...
        if fingers[1] == 1 and fingers[2] == 1 and fingers[3] == 0 and fingers[4] == 0 and fingers[0] == 0:
            ...
            # cv2.putText(img, str(py2), (10,150), cv2.FONT_HERSHEY_PLAIN, 3, (255,0,255), 3)
            # cv2.putText(img, str(cy2), (10,190), cv2.FONT_HERSHEY_PLAIN, 3, (255,0,255), 3)
